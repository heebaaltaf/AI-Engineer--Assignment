...
class TestPipeline(unittest.TestCase):
    ...
    def test_pdf_node_with_mock(self, mock_vs, mock_call):
        ...
        mock_call.return_value = "Summary of Test PDF Content"
        ...
        self.assertIn("Summary of Test PDF Content", result["data"])
